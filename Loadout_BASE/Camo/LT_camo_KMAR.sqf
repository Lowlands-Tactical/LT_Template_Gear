...
File: LT_camo_DSI.sqf ////\\\\WORD KMAR OMDAT DSI ER NOG NIET IS////\\\\
Tijdperl: Heden
...
_unif = ["NAF_U_GVT_kmar","NAF_U_GVTV_kmar"];
_vest = ["NAF_V_PlateCarrier2_kmar","NAF_V_PlateCarrierGL_kmar","NAF_V_PlateCarrierSpec_kmar"];
_helm = ["NAF_H_HelmetIA_kmar"];
...
_vestCrew = ["NAF_V_PlateCarrier1_kmar"];
_helmCrew = ["NAF_H_MilCap_kmar"];

_unifHeliP = ["NAF_U_Overalls_kmar"];
_unifHeliC = ["NAF_U_Overalls_kmar"];
_vestHeli = ["V_TacVest_blk"];
_helmHeli = ["NAF_PilotHelmetHeli_kmar"];
