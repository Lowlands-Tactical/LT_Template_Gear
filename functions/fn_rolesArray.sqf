...
private _roles = ["com","sql","jtac","ftl","gren","comms","rifl","riflat","riflaa","dmr","ar","aar","medic","eng","hmg","hat","vhco","vhgu","vhdr","pilot","crew","jet","lvdw"];
...
private _result = switch (_roleSelect) do
{
	...
	case "Large":	{[_roles #7, _roles #8, _roles #11, _roles #13, _roles #14, _roles #15]};
	case "Crew":	{[_roles #16, _roles #17, _roles #18, _roles #19, _roles #20, _roles #21]};
	case "Special":	{[_roles #4 ,_roles #7,_roles #13, _roles #16, _roles #17, _roles #18, _roles #19]};
	...
	case "Laser":	{[_roles #0, _roles #1, _roles #2, _roles #3, _roles #9, _roles #15, _roles #16, _roles #17, _roles #18, _roles #19, _roles #20]};
};
